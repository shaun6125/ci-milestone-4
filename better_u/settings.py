...
# Define STATICFILES_LOCATION to organize static files within S3
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 's3://betteru'
...
CSRF_TRUSTED_ORIGINS = [
    'https://8000-shaun6125-cimilestone4-yi3vy9hj76p.ws-eu117.gitpod.io',
]
